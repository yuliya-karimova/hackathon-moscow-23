<template>
  <div class="text-gray-800">
    ...
    <!-- main block -->
    <div class="px-8 py-4 md:py-16">
      <div class="flex mx-auto max-w-screen-xl">
        <div class="w-1/2 uppercase z-10 space-y-10 py-10 md:py-20 flex-col justify-center">
          ...
          <div class="flex gap-3 md:gap-6 flex-col md:flex-row">
            <button
              class="bg-orange-500 hover:bg-orange-400 transition duration-150 text-white py-3 px-5 flex items-center justify-center gap-4 font-medium sm:w-64 rounded-lg"
